...
func APIMappingResource(mg resource.Managed) ([]resource.Managed, error) {
	source := mg.(*srcv1alpha1.APIMapping)
	target := &targetv1beta1.APIMapping{}
	skipFields := []string{
		"spec.forProvider.region",
	}
	if _, err := migration.CopyInto(source, target, targetv1beta1.APIMapping_GroupVersionKind, skipFields...); err != nil {
