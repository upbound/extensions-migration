...
func dynamodbResource(mg resource.Managed) ([]resource.Managed, error) {
...
func dynamodbComposition(sourceTemplate v1.ComposedTemplate, convertedTemplates ...*v1.ComposedTemplate) error {
