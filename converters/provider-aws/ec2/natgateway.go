...
func NATGatewayResource(mg resource.Managed) ([]resource.Managed, error) {
	source := mg.(*srcv1beta1.NATGateway)
	target := &targetv1beta1.NATGateway{}
	if _, err := migration.CopyInto(source, target, targetv1beta1.NATGateway_GroupVersionKind, "spec.forProvider.tags"); err != nil {
...
func NATGatewayComposition(sourceTemplate v1.ComposedTemplate, convertedTemplates ...*v1.ComposedTemplate) error {
