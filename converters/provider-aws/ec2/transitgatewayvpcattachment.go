...
func TransitGatewayVPCAttachmentResource(mg resource.Managed) ([]resource.Managed, error) {
	source := mg.(*srcv1alpha1.TransitGatewayVPCAttachment)
	target := &targetv1beta1.TransitGatewayVPCAttachment{}
	if _, err := migration.CopyInto(source, target, targetv1beta1.TransitGatewayVPCAttachment_GroupVersionKind, "spec.forProvider.tags"); err != nil {
...
func TransitGatewayVPCAttachmentComposition(sourceTemplate v1.ComposedTemplate, convertedTemplates ...*v1.ComposedTemplate) error {
